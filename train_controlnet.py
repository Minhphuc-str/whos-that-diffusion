...
def log_validation(
    ...
    for validation_prompt, validation_image in zip(validation_prompts, validation_images):
        validation_image = PIL.Image.open(validation_image).convert("RGB")
...
def make_train_dataset(args, tokenizer, accelerator):
    ...
    with accelerator.main_process_first():
        if "image" in dataset["train"].column_names:
            dataset["train"] = dataset["train"].cast_column("image", datasets.Image())
        if "conditioning_image" in dataset["train"].column_names:
            dataset["train"] = dataset["train"].cast_column("conditioning_image", datasets.Image())
